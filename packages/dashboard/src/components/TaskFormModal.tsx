...
export function TaskFormModal({
  ...
  const [form, setForm] = useState({
    ...
    schedule_type: (editTask?.schedule_type ||
      defaultScheduleType ||
      'cron') as 'cron' | 'interval' | 'once',
    schedule_value: editTask?.schedule_value || defaultScheduleValue || '',
    context_mode: (editTask?.context_mode || 'isolated') as
      | 'group'
      | 'isolated',
  });
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4">
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                setForm((f) => ({ ...f, group_folder: e.target.value }))
              }
              disabled={isEdit}
              className={cn(
          ...
          <div>
              ...
              <div className="flex gap-1.5 mb-2 flex-wrap">
                {(
                  ...
                  <button
                    ...
                    type="button"
                    onClick={() =>
                      setForm((f) => ({ ...f, schedule_value: value }))
                    }
                    className={cn(
            ...
            <input
              ...
              onChange={(e) =>
                setForm((f) => ({ ...f, schedule_value: e.target.value }))
              }
              required
