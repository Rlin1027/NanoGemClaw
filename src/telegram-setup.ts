...
if (!token) {
    ...
    console.error('║  3. Copy the token and create .env file:                     ║');
    console.error('║     echo "TELEGRAM_BOT_TOKEN=your_token_here" > .env         ║');
...
bot.getMe()
    .then((me) => {
        ...
        console.log('║  2. Make it an admin (so it can read messages)               ║');
        console.log('║  3. Run: npm run dev                                         ║');
        console.log('║  4. Send @Andy hello in your group                           ║');
        console.log('╚══════════════════════════════════════════════════════════════╝');
        process.exit(0);
    })
    .catch((err) => {
