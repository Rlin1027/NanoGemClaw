...
<p align="center">
  Персональный ИИ-ассистент на базе <strong>Gemini</strong>. Безопасно работает в контейнерах. Лёгкий и создан для понимания, настройки и расширения.
</p>
...
| **Архитектура** | Монолит | Модульный монорепо (7 пакетов) |
...
- **Интеграция с календарём** — Подписка на потоки iCal и запрос предстоящих событий.
...
- **Веб-панель управления** — Командный центр в реальном времени с 9 модулями: потоковая передача логов, редактор памяти, аналитика и другое.
...
| **Настройки** | Режим обслуживания, отладочное логирование, статус секретов, предпочтения |
...
npm test                  # Все тесты (Vitest, 12 файлов, ~330 тестов)
