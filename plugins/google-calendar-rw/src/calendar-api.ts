...
function getCalendar() {
    ...
    if (!auth) {
        throw new Error('Google Calendar: not authenticated. Authorize via Settings → Google Account.');
    }
 ...
 */
export async function listEvents(options: ListEventsOptions = {}): Promise<CalendarEventData[]> {
