...
- **Web 控制面板** — 9 模块实时指挥中心，包含日志流、内存编辑器、数据分析、Google 账户管理及 Discord 设置等功能。
...
NanoGemClaw 在 `plugins/` 目录中内置 6 个插件：
...
npm test                  # 运行所有测试（Vitest，28 个文件，约 600 个测试）
